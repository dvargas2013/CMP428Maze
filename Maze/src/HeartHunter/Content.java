...
public class Content {
	...
	public static BufferedImage[][] HEART = load("/Sprites/heart.gif", 16, 16);
	...
	public static void drawString(Graphics g, String s, int x, int y) {
		...
		for (int i = 0; i < s.length(); i++) {
			...
			g.drawImage(font[row][col], (x + 8 * i) * GamePanel.SCALE, y * GamePanel.SCALE,
					font[row][col].getWidth() * GamePanel.SCALE, font[row][col].getHeight() * GamePanel.SCALE, null);
		}
	}
}
