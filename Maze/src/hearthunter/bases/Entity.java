...
public abstract class Entity {
	...
	/**
	 * @return whether or not the entity can move into the next position.
	 */
	...
	public void draw(Graphics g) {
		...
		g.drawImage(bi, (x + xmap - width / 2) * GamePanel.SCALE, (y + ymap - height / 2) * GamePanel.SCALE,
				bi.getWidth() * GamePanel.SCALE, bi.getHeight() * GamePanel.SCALE, null);
	}
